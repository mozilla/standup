    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=standup.api.models.generate_token,
                                           help_text='API token for authentication.', max_length=36)),
                ...
                ('contact', models.CharField(default='', max_length=200,
                                             help_text='Contact information for what uses this token. '
                                                       'Email address, etc.', blank=True)),
